<?php
   ...
   // $main_em  = $_SESSION['email'];
    ...
    $sql_report  = "SELECT * FROM report_job";    
    $report_res = mysqli_query($conn,$sql_report) Or die("Failed to query " . mysqli_query($conn));
    $count_report = mysqli_num_rows($report_res);
    //$row_report = mysqli_fetch_assoc($report_res);
		...
		<div class="job-tab text-center">
			<ul class="nav nav-tabs justify-content-center" role="tablist">
				<li role="presentation" class="active">
					<a class="active show" href="#hot-jobs" aria-controls="hot-jobs" role="tab" data-toggle="tab" aria-selected="true">Reported jobs</a>
				</li>
			</ul>
				...
				<div role="tabpanel" class="tab-pane fade active show" id="hot-jobs">
					<div class="row">
						<?php
							if($count_report>0)
							{
								while($row_report=mysqli_fetch_assoc($report_res))
								{
									$job_id = $row_report['job_id'];
									$sql_job= "SELECT * FROM post_job WHERE id ='$job_id'";
									$sql_q = mysqli_query($conn,$sql_job) Or die("Failed to query " . mysqli_error($conn));
									$row_best = mysqli_fetch_assoc($sql_q);
									...
									<div class="job-item">
										<div class="item-overlay">
											<div class="job-info">
												...
												<span class="tr-title">
													<a href= report.php?id=' . $row_best['id'] . '>' . $row_best['position'] . '</a>
													<span><a href=report.php?id=' . $row_best['id'] . '>Open</a></span>
												</span>
